...
typedef struct RegionStyle
{
    ...
    /*
    *  mTextFlow   1: normal flow    2: text reversal flow
    */
    unsigned char     mTextFlow;            /* BD_TEXTST_FLOW_* */

    /*
    *  mTextHalign  text horizontal align  1: left align 3: right align  other: center align
    */
    unsigned char     mTextHalign;          /* BD_TEXTST_HALIGN_* */ // horizontal_alignment

    /*
    * mTextValign  text vertical align 1: Top align   2: Center align   other: Bottom align
    */
    ...
    unsigned char     mFontIncDec;  /* value to adjust font size */
